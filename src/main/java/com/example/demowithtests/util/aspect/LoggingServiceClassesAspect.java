...
import static com.example.demowithtests.util.aspect.ColorConstant.ANSI_BLUE;
import static com.example.demowithtests.util.aspect.ColorConstant.ANSI_RESET;
...
public class LoggingServiceClassesAspect {
    ...
    public void logAfter(JoinPoint joinPoint, Object returningValue) {
        ...
        if (returningValue != null) {
            ...
            log.debug(ANSI_BLUE + "Service: " + methodName + " - end. \n Returns - {}" + ANSI_RESET, outputValue);
        } else {
